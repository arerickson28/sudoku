function getSpaces(groupingNum, groupingType) {
    if(groupingType == "row") {
...
function getColSpaces(groupingNum, grid) {
    let spaces = []
    for(let i=0; i<=9; i++) {
...
function getBoxSpaces(groupingNum, grid) {
    let spaces = []
    switch(groupingNum) {
        case 0:
          spaces = [
...
function getNumbersNeeded(spaces) {
    let numbersNeeded = []
    for (let i = 1; i<10; i++) {
...
function getNumbersFulfilled(spaces) {
    let numbersFulfilled = []
