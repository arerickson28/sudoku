...
export default class Sudoku {
    ...
    constructor(selectedGrid: number[][]) {
        ...
        this.row2 = new GridGrouping(2, "row", selectedGrid)
        this.row3 = new GridGrouping(3, "row", selectedGrid)
        this.row4 = new GridGrouping(4, "row", selectedGrid)
        this.row5 = new GridGrouping(5, "row", selectedGrid)
        this.row6 = new GridGrouping(6, "row", selectedGrid)
        this.row7 = new GridGrouping(7, "row", selectedGrid)
        this.row8 = new GridGrouping(8, "row", selectedGrid)

        this.col0 = new GridGrouping(0, "col", selectedGrid)
        this.col1 = new GridGrouping(1, "col", selectedGrid)
        this.col2 = new GridGrouping(2, "col", selectedGrid)
        this.col3 = new GridGrouping(3, "col", selectedGrid)
        this.col4 = new GridGrouping(4, "col", selectedGrid)
        this.col5 = new GridGrouping(5, "col", selectedGrid)
        this.col6 = new GridGrouping(6, "col", selectedGrid)
        this.col7 = new GridGrouping(7, "col", selectedGrid)
        this.col8 = new GridGrouping(8, "col", selectedGrid)
          
        this.box0 = new GridGrouping(0, "box", selectedGrid)
        this.box1 = new GridGrouping(1, "box", selectedGrid)
        this.box2 = new GridGrouping(2, "box", selectedGrid)
        this.box3 = new GridGrouping(3, "box", selectedGrid)
        this.box4 = new GridGrouping(4, "box", selectedGrid)
        this.box5 = new GridGrouping(5, "box", selectedGrid)
        this.box6 = new GridGrouping(6, "box", selectedGrid)
        this.box7 = new GridGrouping(7, "box", selectedGrid)
        this.box8 = new GridGrouping(8, "box", selectedGrid)
